...
class TimePage(BasePage, BaseElement):
    ...
    def __init__(self, driver):
        ...
        # Кнопки
        self.VIEW_BUTTON = BaseElement(
            driver, (By.CSS_SELECTOR, "button[type='submit']")
        )
        self.VIEW_FIRST_BUTTON = BaseElement(
            driver, (By.XPATH, "(//button[@type='button'])[4]")
        )
        self.VIEW_LAST_BUTTON = BaseElement(
            driver, (By.XPATH, "(//button[@type='button'])[last()]")
        )
        # Сообщение об ошибке
