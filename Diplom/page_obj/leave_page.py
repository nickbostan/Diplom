...
class LeavePage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.FROM_DATE_FIELD = BaseElement(driver, (By.XPATH, "(//input[@placeholder='yyyy-dd-mm'])[1]"))
        self.TO_DATE_FIELD = BaseElement(driver, (By.XPATH, "(//input[@placeholder='yyyy-dd-mm'])[2]"))
    ...
    def check_that_page_opened(self):
        ...
        self.FROM_DATE_FIELD.should_be_visible()
