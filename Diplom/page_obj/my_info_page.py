...
class MyInfoPage(BasePage, BaseElement):
    ...
    def __init__(self, driver):
        ...
        # Вкладки
        self.PERSONAL_DETAILS = BaseElement(
            driver, (By.XPATH, "//a[text()='Personal Details']")
        )
        self.CONTACT_DETAILS = BaseElement(
            driver, (By.XPATH, "//a[text()='Contact Details']")
        )
        self.EMERGENCY_CONTACTS = BaseElement(
            driver, (By.XPATH, "//a[text()='Emergency Contacts']")
        )
        ...
        self.QUALIFICATIONS = BaseElement(
            driver, (By.XPATH, "//a[text()='Qualifications']")
        )
        ...
        self.NICKNAME = BaseElement(
            driver, (By.XPATH, "(//input[@class='oxd-input oxd-input--active'])[5]")
        )
        self.ID = BaseElement(
        ...
        self.LICENSE_EXPIRE = BaseElement(
            driver, (By.CSS_SELECTOR, "input[placeholder='yyyy-dd-mm']")
        )
        ...
        self.SAVE_ATTACH = BaseElement(
            driver, (By.XPATH, "(//button[@type='submit'])[3]")
        )
