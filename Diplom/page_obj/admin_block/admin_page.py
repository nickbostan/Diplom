...
class AdminPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.REDACT_SECOND = BaseElement(
            driver, (By.XPATH, "(//button[@type='button'])[10]")
        )
        # Чекбоксы
        ...
        self.COUNT = BaseElement(
            driver, (By.XPATH, "(//span[@class='oxd-text oxd-text--span'])[13]")
        )
        ...
        self.CONFIRMATION = BaseElement(
            driver, (By.XPATH, "(//button[@class='oxd-button--label-danger'])[2]")
        )
        self.JOB = BaseElement(driver, (By.XPATH, "//span[text()='Job']"))
        self.USER_MANAGEMENT = BaseElement(
            driver, (By.XPATH, "//span[contains(text(), 'User Management')]")
        )
        self.ORGANIZATION = BaseElement(
            driver, (By.XPATH, "//span[text()='Organization ']")
        )
        self.QUALIFICATIONS = BaseElement(
            driver, (By.XPATH, "//span[text()='Qualifications ']")
        )
    ...
    def check_that_page_opened(self):
        ...
        self.FIRST_CHECK.should_be_not_visible()
