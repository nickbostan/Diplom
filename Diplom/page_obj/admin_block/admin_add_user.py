...
class AdminAddPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.USER_ROLE = BaseElement(driver, (By.XPATH, "(//div[@class='oxd-select-text-input'])[1]"))
        self.ROLE_ADMIN = BaseElement(driver, (By.XPATH, f".//*[contains(text(), 'Admin')]"))
        self.ROLE_ESS = BaseElement(driver, (By.XPATH, f".//*[contains(text(), 'ESS')]"))
        self.STATUS = BaseElement(driver, (By.XPATH, "(//div[@class='oxd-select-text-input'])[2]"))
        self.STATUS_ENABLED = BaseElement(driver, (By.XPATH, f".//*[contains(text(), 'Enabled')]"))
        self.STATUS_DISABLED = BaseElement(driver, (By.XPATH, f".//*[contains(text(), 'Disabled')]"))
        self.INPUT_EMPLOYEE_NAME = BaseElement(driver, (By.XPATH, "//input[@placeholder='Type for hints...']"))
        self.MAIN_NAME = BaseElement(driver, (By.XPATH, "//p[@class='oxd-userdropdown-name']"))
        self.FIRST_FOUND_EMPLOYEE = BaseElement(driver, (By.XPATH, "//div[@class='oxd-autocomplete-option']"))
        self.INPUT_USERNAME = BaseElement(driver, (By.XPATH, "(//input[contains(@class, 'oxd-input oxd-input--active')])[2]"))
        self.INPUT_PASSWORD = BaseElement(driver, (By.XPATH, "//input[@type='password']"))
        self.TABLE = BaseElement(driver, (By.XPATH, "//div[@row-decorator()='oxd-table-decorator-card']"))
        ...
        # Ошибки
        self.ERROR_LENGTH_PASS = BaseElement(driver, (By.CLASS_NAME, "oxd-input-field-error-message"))
        self.ERROR_WEAK_PASS = BaseElement(driver, (By.CLASS_NAME, "oxd-input-field-error-message"))
        self.ERROR_MATCH_PASS = BaseElement(driver, (By.CLASS_NAME, "oxd-input-field-error-message"))
        ...
        self.SUCCESS = BaseElement(driver, (By.XPATH, "//p[contains(@class, 'oxd-toast-content-text') and contains(text(), 'Successfully Saved')]"))
