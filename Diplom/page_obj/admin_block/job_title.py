...
class JobTitlePage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.MENU_ADMIN = BaseElement(driver, (By.XPATH, "//span[text()='Directory']"))
        self.ADMIN_JOB = BaseElement(driver, (By.XPATH, "//span[text()='Job ']"))
        self.ADMIN_JOB_TITLES = BaseElement(driver, (By.XPATH, "//a[@class='oxd-topbar-body-nav-tab-link' and text()='Job Titles']"))
        # Кнопки
        self.ADD_BUTTON = BaseElement(driver, (By.XPATH, "(//button[@type='button'][4]"))
        self.DELETE_FIRST = BaseElement(driver, (By.XPATH, "(//button[@type='button'][5]"))
        self.REDACT_FIRST = BaseElement(driver, (By.XPATH, "(//button[@type='button'][6]"))
        self.DELETE_SECOND = BaseElement(driver, (By.XPATH, "(//button[@type='button'][7]"))
        self.REDACT_SECOND = BaseElement(driver, (By.XPATH, "(//button[@type='button'][8]"))
...
def check_that_page_opened(self):
        ...
        self.PAGE_TITLE.should_be_has_text("Job Titles")
